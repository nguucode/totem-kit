// The raw ramps the semantic tokens are cut from. Kept as data rather than
// generated classes so this page does not need a utility framework to render.
export const PALETTE: Record<string, string[]> = {
  ...
  cyan: [
    ...
    'oklch(52.0% 0.105 223.128)',
    'oklch(45.0% 0.085 224.283)',
  ...
  indigo: [
    ...
    'oklch(93.0% 0.034 272.788)',
    'oklch(87.0% 0.065 274.039)',
